...
class EnrichmentAgent:
    ...
    def _categorize_company(self, company_name: str, funding: Dict) -> str:
        ...
        description = (funding.get('description') or '').lower()
        category = (funding.get('category') or '').lower()
    ...
    def _categorize_product(self, launch: Dict) -> str:
        ...
        description = (launch.get('description') or '').lower()
        category = (launch.get('category') or '').lower()
